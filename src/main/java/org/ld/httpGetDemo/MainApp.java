...
public class MainApp {
    ...
    // 查看我的秘钥 我的Key
    private static final String appkey = "bac15274573d4568b6f822895b39922b";
    private static final String seckey = "228613A9D80CF430F2148E0B41E08D38";

    public static void main(String[] args) {
        String reqInterNme = "http://api.qichacha.com/ECIV4/Search";
        String paramStr = "keyword=宁波通商银行";
        String status = "";
        try {
            // auth header setting
